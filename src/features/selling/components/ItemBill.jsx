...
function ItemBill({ billId, staffId, staffName, createdAt, customerId, customerName, totalPrice, children }) {
  return (
    <ul className="flex justify-between items-center bg-slate-50 p-2 rounded-[4px] gap-2 text-h5 px-2 flex-shrink-0 border-[1px] border-text_blur/30 text-text_primary">
